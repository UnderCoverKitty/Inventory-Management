...
public class ReceiptPreviewPanel extends JPanel {
    ...
    public ReceiptPreviewPanel(String orderId, String customerName, String cashierName, 
    ...
    protected void paintComponent(Graphics g) {
        ...
        // Using monospaced fonts with larger size for preview
        Font titleFont = new Font("Monospaced", Font.BOLD, 18);
        Font headerFont = new Font("Monospaced", Font.BOLD, 14);
        Font regularFont = new Font("Monospaced", Font.PLAIN, 13);
        ...
        // Column Headers
        String itemHeader = String.format("%-15s %3s %6s %6s", "ITEM", "QTY", "PRICE", "TOTAL");
        ...
        for (String[] item : items) {
            String itemLine = String.format("%-15s %3s %6s %6s",
                truncateString(item[0], 15),
                item[2],
                "Rs" + item[1],
                "Rs" + item[3]);
        ...
        String total = String.format("TOTAL: Rs. %d", totalPaid);
